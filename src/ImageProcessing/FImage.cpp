...
bool FImage::is_detected() {
    return is_persons_detected;
}

bool FImage::is_recognized() {
    return is_persons_recognized;
}
...
std::vector<FFaceArea *> FImage::get_faces() {
...
const cv::Mat &FImage::get_image() const {
